    ...
    items: [
      {
        ...
        badge: "매우 쉬움",
        icon: "🔍",
        link: "/develop-guide/trade#1-수취인-성명-조회-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        badge: "매우 쉬움",
        icon: "📞",
        link: "/develop-guide/trade#2-ars-출금동의-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        badge: "매우 쉬움",
        icon: "📑",
        link: "/develop-guide/trade#3-출금계좌등록-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        badge: "매우 쉬움",
        icon: "💸",
        link: "/develop-guide/trade#4-1원이체-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        badge: "매우 쉬움",
        icon: "💳",
        link: "/develop-guide/trade#5-출금이체-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "출금 금액 일부 환불 요청",
        icon: "↩️",
        link: "/develop-guide/trade#6-부분환불-api",
      },
      {
        title: "전체환불",
        desc: "출금 금액 전체 환불 요청",
        icon: "🔄",
        link: "/develop-guide/trade#6-전체환불-api",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "등록된 계좌 해지 요청",
        icon: "🚫",
        link: "/develop-guide/trade#7-전체환불-api",
      },
    ],
  },
];
